...
// @generated from protobuf file "rpc/user/users_response.proto" (package "rpc.user", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message rpc.user.UsersResponse
 */
...
class UsersResponse$Type extends MessageType<UsersResponse> {
  ...
  internalBinaryWrite(
    ...
    /* repeated rpc.user.UserResponse users = 1; */
...
/**
 * @generated MessageType for protobuf message rpc.user.UsersResponse
 */
