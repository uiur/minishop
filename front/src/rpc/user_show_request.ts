...
class UserShowRequest$Type extends MessageType<UserShowRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UserShowRequest): UserShowRequest {
    ...
    internalBinaryWrite(message: UserShowRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 id = 1; */
        if (message.id !== 0)
