...
export interface IUserClient {
   ...
   */
  show(
    input: UserShowRequest,
    options?: RpcOptions
  ): UnaryCall<UserShowRequest, UserResponse>
  /**
  ...
  create(
    ...
    options?: RpcOptions
  ): UnaryCall<UserCreateRequest, UserResponse>
  /**
  ...
  index(
    ...
    options?: RpcOptions
  ): UnaryCall<UserIndexRequest, UsersResponse>
}
/**
 * @generated from protobuf service User
 */
export class UserClient implements IUserClient, ServiceInfo {
  ...
  show(
    ...
    return stackIntercept<UserShowRequest, UserResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  create(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<UserCreateRequest, UserResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  index(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<UserIndexRequest, UsersResponse>(
      'unary',
      this._transport,
      method,
      opt,
